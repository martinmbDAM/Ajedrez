...
public class Jugador {
     ...
     * @param tiempo Tiempo en segundos del que dispone el jugador 
     */
    public Jugador(String nombre, int color, int tiempo){
        this.nombre = nombre;
        this.color = color;
        this.reloj = new Reloj(tiempo);
    }
    ...
    /**
     * Método que permite obtener el reloj
     * @return Reloj
     */
