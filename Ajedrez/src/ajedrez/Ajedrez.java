...
public class Ajedrez extends javax.swing.JFrame implements ActionListener {
    ...
    public Ajedrez(String jugador1, String jugador2, int opcion) {
        ...
        // Jugadores:
        jugadorBlancas = new Jugador(jugador1, Jugador.BLANCO, 180);
        jugadorNegras = new Jugador(jugador2, Jugador.NEGRO, 180);
    ...
    private void initComponents() {
        ...
        relojBlancas = new javax.swing.JLabel();
        ...
        relojBlancas.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        relojBlancas.setForeground(new java.awt.Color(255, 255, 255));
        relojBlancas.setText("0:00");
        panelInferior.add(relojBlancas);
    ...
    private javax.swing.JLabel relojBlancas;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (this.tablero.getNumMovimientos() > 0) {
            if (this.partidaActiva) {

                if (this.turnoBlancas) {

                    synchronized (this.jugadorBlancas.getReloj()) {
                        this.jugadorBlancas.getReloj().reducirTiempo();

                        if (!this.jugadorBlancas.getReloj().isActivo()) {
                    ...
                    synchronized (this.jugadorNegras.getReloj()) {
                        this.jugadorNegras.getReloj().reducirTiempo();

                        if (!this.jugadorNegras.getReloj().isActivo()) {
    ...
    public void pintarTiempo() {
        ...
        if (this.turnoBlancas) {
            this.relojBlancas.setText(this.jugadorBlancas.getReloj().getTiempoFormateado());
        } else {
            this.relojNegras.setText(this.jugadorNegras.getReloj().getTiempoFormateado());
        }
    }
